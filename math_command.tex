...
% Commun
\newcommand\REF{\cR}  % Ensemble des références
...
\newcommand\backOrderPR[2]{b_{#1}^{#2}}             % Back ordered when negative stocks are authorized
\newcommand\aleaBackOrderPR[2]{\va{b}_{#1}^{#2}}    % Back ordered when negative stocks are authorized
\newcommand\forwardOrderPR[2]{\tilde{s}_{#1}^{#2}}          % Forward ordered when negative stocks are authorized
\newcommand\aleaForwardOrderPR[2]{\va{\tilde{s}}_{#1}^{#2}} % Forward ordered when negative stocks are authorized
\newcommand\penalizePR[2]{\gamma_{#1}^{#2}}         % penalization factor
