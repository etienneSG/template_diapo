...
% Kicker at the bottom of the template
\newcommand{\kicker}[1]{\mytext[\xlmargin,{\footerheight+.2cm}]{.93\paperwidth}{anchor = south west, inner sep = 3pt, fill=\secondcolor!25}{\begin{center}#1\end{center}}}
